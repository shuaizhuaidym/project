		...
		<form action="update" method="post">
			...
			<table class="table table-striped table-bordered">
				<tr>
					...
					<td><select name="project.industry" class="form-control">
							<option>军工</option>
							<option>能源</option>
							<option>政府</option>
							<option>公安</option>
				...
				<tr>
					...
					<td><select id="disabledSelect" name="project.issueType" class="form-control">
							<option>网关服务器</option>
							<option>客户端</option>
					...
					<td><input type="text" name="project.prudectVersion" value="${prj.prudectVersion}" class="form-control"></td>
				</tr>
				<tr>
					<td><label class="control-label col-xs-2">提交日期</label></td>
					<td><input type="text" name="project.submitDate" value="${prj.localSubmitDate}" class="form-control"></td>
				...
				<tr>
					...
					<td colspan="3"><textarea name="project.describtion" class="x-text" rows="5">${prj.describtion}</textarea></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3"><input type="text" name="project.laborCosts" value="${prj.laborCosts}" class="x-text" /></td>
				</tr>
			</table>
